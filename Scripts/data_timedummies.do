...
xtreg flow_ass c.ln_age##c.agg6returns agg3flow_ass size_ass pastvolatility vwretd tmytm vix m1-m12 y1-y24, fe cluster(name) 
...
reg flow_ass incentivefee managementfee size_ass c.ln_age##c.agg6returns agg3flow_ass pastvolatility ln_min_inv highwatermark lockupperiod redemptionnoticeperiod personalcapital opentopublic leveraged onshore vwretd tmytm vix futures derivatives margin fxcredit category1-category12 legalstruct1-legalstruct34 ae_* af_* ac_* acur_* ap_* sf_* ia_* gf_* if_* m1-m12 y1-y24, cluster(name) 
...
reg flow_ass incentivefee managementfee size_ass ln_age agg6returns age_times_agg6 agg3flow_ass pastvolatility ln_min_inv highwatermark lockupperiod redemptionnoticeperiod personalcapital opentopublic leveraged onshore vwretd tmytm vix futures derivatives margin fxcredit category1-category12 legalstruct1-legalstruct34 ae_* af_* ac_* acur_* ap_* sf_* ia_* gf_* if_* m1-m12 y1-y24 if crisis==0
est sto ols_before 

reg flow_ass incentivefee managementfee size_ass ln_age agg6returns age_times_agg6 agg3flow_ass pastvolatility ln_min_inv highwatermark lockupperiod redemptionnoticeperiod personalcapital opentopublic leveraged onshore vwretd tmytm vix futures derivatives margin fxcredit category1-category12 legalstruct1-legalstruct34 ae_* af_* ac_* acur_* ap_* sf_* ia_* gf_* if_* m1-m12 y1-y24 if crisis==2
est sto ols_during

reg flow_ass incentivefee managementfee size_ass ln_age agg6returns age_times_agg6 agg3flow_ass pastvolatility ln_min_inv highwatermark lockupperiod redemptionnoticeperiod personalcapital opentopublic leveraged onshore vwretd tmytm vix futures derivatives margin fxcredit category1-category12 legalstruct1-legalstruct34 ae_* af_* ac_* acur_* ap_* sf_* ia_* gf_* if_* m1-m12 y1-y24 if crisis==1
est sto ols_after
